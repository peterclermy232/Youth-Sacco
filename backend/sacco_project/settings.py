...
# Security settings
SECRET_KEY = config('SECRET_KEY', default='django-insecure-_bxf@qo(859pkvvagjh*y)fm_5-%)(37rig(yen6ut*d30@&$a')
...
DATABASES = {
    'default': {
        ...
        'USER': config('DB_USER', default='sacco_user'),
        'PASSWORD': config('DB_PASSWORD', default='sacco_password'),
