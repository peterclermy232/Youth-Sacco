...
@Component({
  selector: 'app-admin-verify-contributions',
  standalone: true,
  imports: [
    CommonModule,
    ReactiveFormsModule,
  ...
  templateUrl: './admin-verify-contributions.component.html',
  styleUrls: ['./admin-verify-contributions.component.scss']
})
export class AdminVerifyContributionsComponent implements OnInit {
